...
cat > "$PROJECT_DIR/.create-admin-temp.js" << 'ENDOFSCRIPT'
...
cd "$PROJECT_DIR"
node .create-admin-temp.js "$EMAIL" "$PHONE" "$PASSWORD" "$FIRSTNAME" "$LASTNAME" "$COUNTRY"
...
# Nettoyer
rm "$PROJECT_DIR/.create-admin-temp.js"
